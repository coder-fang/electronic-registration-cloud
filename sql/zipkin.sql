...
CREATE TABLE `zipkin_annotations`  (
  ...
  `a_timestamp` bigint NULL DEFAULT NULL COMMENT 'Used to implement TTL; Annotation.timestamp or zipkin_spans.timestamp',
  `endpoint_ipv4` int NULL DEFAULT NULL COMMENT 'Null when Binary/Annotation.endpoint is null',
  `endpoint_ipv6` binary(16) NULL DEFAULT NULL COMMENT 'Null when Binary/Annotation.endpoint is null, or no IPv6 address',
  `endpoint_port` smallint NULL DEFAULT NULL COMMENT 'Null when Binary/Annotation.endpoint is null',
...
CREATE TABLE `zipkin_dependencies`  (
  ...
  `call_count` bigint NULL DEFAULT NULL,
  `error_count` bigint NULL DEFAULT NULL,
...
CREATE TABLE `zipkin_spans`  (
  ...
  `start_ts` bigint NULL DEFAULT NULL COMMENT 'Span.timestamp(): epoch micros used for endTs query and to implement TTL',
  `duration` bigint NULL DEFAULT NULL COMMENT 'Span.duration(): micros used for minDuration and maxDuration query',
